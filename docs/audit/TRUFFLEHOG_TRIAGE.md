...
**Latest fully triaged artifact:** `29416245559`

**Latest reproducing PR run:** `29611633518` (20 unverified findings)
...
The gate is **blocking**. The fully triaged sanitized artifact contains 20 findings: zero
...
substitute for provider revocation or impact evidence.
...
| ---: | --- | --- | --- | ---: | --- | --- |
| 1 | URI | Unverified | `neuron/tests/test_gateway_client_security.py` | 32 | `31929a24419a9b7b9d8954cbea2df9fe1cb77a68` | Refactor the userinfo fixture through a URL builder, then replace the historical literal. |
...
| 4 | Postgres | Unverified | `neuron/.env.example` | 23 | `0161faebfba436fd3140d94dd0b9dbc91744f1bb` | Use separate environment placeholders, then replace the historical literal. |
| 5 | Postgres | Unverified | `neuron/docs/WORKFLOW_ENGINE.md` | 43 | `0161faebfba436fd3140d94dd0b9dbc91744f1bb` | Use separate environment placeholders, then replace the historical literal. |
| 6 | Postgres | Unverified | `neuron/dbos_config.py` | 34 | `0161faebfba436fd3140d94dd0b9dbc91744f1bb` | Use separate environment placeholders, then replace the historical literal. |
...
| 17 | URI | Unverified | `.foundry/crates/anvil/src/cmd.rs` | 413 | `174dbaa0393897107b9eafd283224d23a47572aa` | Remove tracked vendor history; CI installs pinned Foundry independently. |
| 18 | URI | Unverified | `.foundry/crates/anvil/src/cmd.rs` | 746 | `174dbaa0393897107b9eafd283224d23a47572aa` | Remove tracked vendor history; CI installs pinned Foundry independently. |
| 19 | Circle | Unverified | `.foundry/crates/forge/tests/fixtures/backtraces/ForkBacktrace.t.sol` | 11 | `174dbaa0393897107b9eafd283224d23a47572aa` | Remove tracked vendor history; do not allowlist. |
| 20 | Etherscan | Unverified | `.foundry/crates/test-utils/src/rpc.rs` | 87 | `174dbaa0393897107b9eafd283224d23a47572aa` | Remove tracked vendor history; do not allowlist. |
...
- Test, documentation, configuration, and upstream candidates require sampled
  Architect review before any exact path-and-detector allowlist is proposed.
...
require provider revocation or permanent identity-decommission evidence plus
