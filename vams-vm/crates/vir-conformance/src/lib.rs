...
pub const SETTLEMENT_CBOR_FIELD_ORDER: [&str; 10] = [
    "schemaVersion",
    "receiptHash",
    "domainAuthorityBinding",
    "sourceHost",
...
mod tests {
    ...
    const SETTLEMENT_CBOR: &str = "";
    ...
    fn sample_cross_host_settlement_preserves_inv_10() {
        ...
        assert_eq!(settlement.source_host(), HostAuthority::PolygonAmoy);
        assert_eq!(settlement.destination_host(), HostAuthority::CardanoPreProd);
