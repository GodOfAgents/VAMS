...
interface IServiceBlockRegistry {
    ...
    event ServiceBlockRegistered(
        bytes32 indexed blockId, address indexed builder, string name, string category, uint256 revenueShareBps
    );
    ...
    event ServiceBlockProvisioned(bytes32 indexed blockId, address indexed agent, uint256 provisionCount);
