 ...
 */
contract RoutingProofVerifier is Initializable, AccessControlUpgradeable, IRoutingProofVerifier {
     ...
     */
    function verifyRoutingDecision(bytes32 _txHash, RoutingProof calldata _proof) public view override returns (bool) {
        ...
        bytes32 messageHash = keccak256(
            abi.encodePacked(_txHash, _proof.inputMetadataHash, _proof.routingDecisionHash, _proof.routingRulesRoot)
        );
     ...
     */
    function submitProof(bytes32 _txHash, RoutingProof calldata _proof) external {
