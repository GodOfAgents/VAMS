...
interface IProviderBondRegistry {
    ...
    event ProviderRegistered(address indexed provider, uint256 bondAmount, uint256 maxRequestValue);
    event BondIncreased(address indexed provider, uint256 additionalAmount, uint256 newTotal);
    event WithdrawalRequested(address indexed provider, uint256 amount, uint256 unlockTime);
    event WithdrawalExecuted(address indexed provider, uint256 amount);
    event WithdrawalCancelled(address indexed provider);
    event ProviderSlashed(address indexed provider, uint256 amount, bytes32 indexed escrowId, string reason);
    event ProviderCompensated(address indexed provider, uint256 amount, bytes32 indexed escrowId);
    event ProviderDeactivated(address indexed provider, string reason);
    event ProviderReactivated(address indexed provider);
    event RequestAccepted(address indexed provider, bytes32 indexed escrowId, uint256 value);
    event RequestCompleted(address indexed provider, bytes32 indexed escrowId);
    event MaxRequestValueUpdated(address indexed provider, uint256 oldValue, uint256 newValue);
     ...
     */
    function getActiveRequest(bytes32 escrowId) external view returns (ActiveRequest memory);
     ...
     */
    function slashProvider(address provider, uint256 amount, bytes32 escrowId, string calldata reason) external;
     ...
     * @param escrowId Failed escrow identifier
     */
    function compensateProvider(address provider, uint256 amount, bytes32 escrowId) external;
}
