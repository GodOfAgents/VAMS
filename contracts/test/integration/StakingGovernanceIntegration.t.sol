...
contract StakingGovernanceIntegration is BaseTest {
    ...
    function setUp() public override {
        ...
        vm.prank(admin);
        staking = new VAMSStaking(address(vamsToken), address(vamsToken), EMISSION_RATE, admin);
    ...
    function test_TierProgression_SilverToPlat() public {
        ...
        assertEq(uint256(staking.getTier(user1)), uint256(IVAMSStaking.StakingTier.Silver));
        ...
        assertEq(uint256(staking.getTier(user1)), uint256(IVAMSStaking.StakingTier.Gold));
        assertFalse(staking.isCLROperatorEligible(user1));
        ...
        assertEq(uint256(staking.getTier(user1)), uint256(IVAMSStaking.StakingTier.Platinum));
    ...
    function test_APY_Calculation() public {
        ...
        uint256 apySilver7d = staking.getAPY(IVAMSStaking.StakingTier.Silver, IVAMSStaking.LockPeriod.SevenDays);
        uint256 apyPlatinum180d =
            staking.getAPY(IVAMSStaking.StakingTier.Platinum, IVAMSStaking.LockPeriod.OneEightyDays);
