...
contract VAMSAgentRegistryTest is Test {
    ...
    function test_RegisterAgent_RevertOnInsufficientStake() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                VAMSAgentRegistry.InsufficientStake.selector,
                1000 ether,
                500 ether
            )
        );
    ...
    function test_FinalizeAgent_RevertBeforeChallengeWindow() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                VAMSAgentRegistry.ChallengeWindowNotExpired.selector,
    ...
    function test_SubmitChallenge() public {
        ...
        registry.submitChallenge(
            agentId,
            keccak256("fraud_proof"),
            100 ether,
            "ipfs://evidence"
        );
        vm.stopPrank();
    ...
    function test_ResolveChallenge_FraudProven() public {
        ...
        vm.startPrank(challenger);
        token.approve(address(registry), 100 ether);
        bytes32 challengeId = registry.submitChallenge(
            agentId,
            keccak256("fraud_proof"),
            100 ether,
            "ipfs://evidence"
