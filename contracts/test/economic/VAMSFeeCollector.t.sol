...
contract VAMSFeeCollectorTest is BaseTest {
    ...
    event DistributionUpdated(
        IVAMSFeeCollector.DistributionPhase phase,
        uint256 burnBps,
        uint256 stakingBps,
        uint256 treasuryBps,
    ...
    function setUp() public override {
        ...
        bytes memory initData = abi.encodeWithSelector(
            VAMSFeeCollector.initialize.selector, admin, address(token), treasury, stakingContract, insuranceFund
        );
    ...
    function test_TransitionPhase_EmitsEvent() public {
        vm.expectEmit(true, true, true, true);
        emit DistributionUpdated(IVAMSFeeCollector.DistributionPhase.PHASE_2, 4000, 3000, 2000, 1000);
