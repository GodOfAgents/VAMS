...
contract TransactionCompensationTest is BaseTest {
    ...
    function setUp() public override {
        ...
        bytes memory initData = abi.encodeWithSelector(
            TransactionCompensation.initialize.selector,
            admin,
            guardians,
            address(token),
            insuranceFund
    ...
    function test_SubmitClaim_Revert_NoActiveIncident() public {
        ...
        vm.prank(user1);
        compensation.submitClaim(testTxHash, ITransactionCompensation.TransactionType.SETTLEMENT, testAmount, testEvidence);
    }
    ...
    function test_SubmitClaim_Revert_ExceedsMaxAmount() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ITransactionCompensation.AmountExceedsMaximum.selector, excessiveAmount, 100_000 ether));
        vm.prank(user1);
        compensation.submitClaim(testTxHash, ITransactionCompensation.TransactionType.SETTLEMENT, excessiveAmount, testEvidence);
    }
    ...
    function test_BatchProcessClaims() public {
        ...
        vm.prank(user1);
        compensation.submitClaim(testTxHash, ITransactionCompensation.TransactionType.SETTLEMENT, 100 ether, testEvidence);
